...
describe("SkillsTab", () => {
  ...
  it("Add skill menu: three doors; Create with Kada ya moko hands off to a conversation", async () => {
    ...
    fireEvent.click(screen.getByText("Create with Kada ya moko"));
  ...
  it("the list is the page: no standing add-surfaces, no drafting remnants", async () => {
    ...
    expect(screen.queryByText("Ask Kada ya moko to revise")).toBeNull();
