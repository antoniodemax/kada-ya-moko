...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .setup(move |app| {
            ...
            let open_i = MenuItem::with_id(app, "open", "Open Kada ya moko", true, None::<&str>)?;
        ...
        .expect("error while building the Kada ya moko desktop app")
        .run(|app, event| {
